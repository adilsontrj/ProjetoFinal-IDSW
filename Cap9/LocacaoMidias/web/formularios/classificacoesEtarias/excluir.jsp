...
<html>
  ...
  <body>
    ...
    <h1 style="text-align: center; font-family: sans-serif; margin: 10px 20px">Excluir Classificação Etária</h1>
    ...
    <form method="post" action="${cp}/processaClassificacoesEtarias">
      ...
      <table>
        <tr>
          ...
          <td style="color: #000">${requestScope.classificacaoEtaria.descricao}</td>
        </tr>
        <tr>
          <td>
              <div class="volta">
